...
# %%
stg_df_followup = add_example_and_leading_columns(
    df=filter_nonempty_object_column(stg_df, column="followup_question"),
    text_column="followup_question",
)

stg_df_followup_example_and_leading_summary = summarise_example_and_leading_columns(
    df=stg_df_followup,
    prefix="followup_question_",
)

print(stg_df_followup_example_and_leading_summary)
# %%
